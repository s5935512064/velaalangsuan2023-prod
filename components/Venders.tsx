...
const venders_list = [
  {
    id: 61,
    name: "Wash Me",
    shopImg: "/assets/shop-gallery/Wash Me/Logo B1_20250502-13.webp",
    keyword: "Wash Me",
    about: "Professional Dry Clean l Laundry l Alterations l Spa l Premium",
    aboutTH:
      "WASH ME บริการ ซัก อบ รีด ซ่อมแซมเสื้อผ้า สปากระเป๋าและรองเท้าโดยผู้เชี่ยวชาญ",
    datetime: "10:00 AM - 7:00 PM",
    datetime2: "",
    tel: "094-455-8299",
    facebook: "https://www.facebook.com/Washmeprofessional/?locale=th_TH",
    ig: "#",
    line: "https://page.line.me/@washmeprofessional",
    deliver: "#",
    grabfood: "#",
    lineman: "#",
    robinhood: "#",
    gallery: [
      { src: "/assets/shop-gallery/Wash Me/washme_1.webp" },
      { src: "/assets/shop-gallery/Wash Me/washme_2.webp" },
      { src: "/assets/shop-gallery/Wash Me/washme_3.webp" },
      { src: "/assets/shop-gallery/Wash Me/washme_4.webp" },
  ...
  },
  {
    ...
    shopImg: "/assets/shop-gallery/Chicha San Chen/CHICHA San Chen.webp",
    keyword: "Chicha San Chen",
    about:
      "A premium Taiwanese tea brand that blends traditional craftsmanship with modern innovation, offering Michelin award-winning, brew-to-order teas through a patented AI Teapresso machine — all with a tea-first focus on authentic high-mountain Taiwanese teas.",
    aboutTH:
      "แบรนด์ชาพรีเมียมจากไต้หวันที่ได้รางวัลเทียบเท่ามิชลิน 3 ดาว เจ้าเดียวในโลก สกัดสดใหม่ทุกแก้วด้วยเครื่อง AI Teapresso ลิขสิทธิ์เฉพาะที่คำนวณอุณหภูมิและเวลาแม่นยำ เพื่อดึงคุณค่าจากใบชาคุณภาพนำเข้าจากไต้หวัน มอบประสบการณ์ชาที่ดีที่สุด",
    datetime: "MON-FRI : \n9:00 AM - 9:00 PM \n SAT-SUN : \n10:00 AM- 9:00 PM",
    datetime2: "",
    tel: "092-267-7571",
    facebook: "www.facebook.com/profile.php?id=61560577678195&mibextid=LQQJ4d",
    ig: "www.instagram.com/chichasanchen.bkk",
    line: "https://line.me/R/ti/p/@467noydk?oat_content=url&ts=11091344",
    deliver: "https://linktr.ee/chichasanchen_bkk",
    grabfood: "#",
    lineman: "#",
    robinhood: "#",
    gallery: [
      { src: "/assets/shop-gallery/Chicha San Chen/chicha_1.webp" },
      { src: "/assets/shop-gallery/Chicha San Chen/chicha_2.webp" },
      { src: "/assets/shop-gallery/Chicha San Chen/chicha_3.webp" },
      { src: "/assets/shop-gallery/Chicha San Chen/chicha_4.webp" },
      { src: "/assets/shop-gallery/Chicha San Chen/chicha_5.webp" },
      { src: "/assets/shop-gallery/Chicha San Chen/chicha_6.webp" },
  ...
  },
  {
    id: 59,
    name: "Kad Kreamery",
    shopImg: "/assets/shop-gallery/Kad Kreamery/Kad Kreamery.webp",
    keyword: "Kad Kreamery",
    about:
      "A French chocolate ice cream brand celebrating Thai seasonal ingredients. Each scoop is handmade, paired with indulging desserts featuring the famous Kad Kokoa chocolate.",
    aboutTH:
      "แบรนด์ไอศครีมที่สรรสร้างขึ้นมาด้วยวัตถุดิบท้องถิ่นด้วยเทคนิคแบบฝรั่งเศสสุดคลาสสิก พร้อมเมนูขนมหวานสุดพิเศษจากช็อคโกแลต Kad Kokoa",
    datetime: "11:00 AM - 9:00 PM",
    datetime2: "",
    tel: "081-007-8828",
    facebook: "#",
    ig: "https://www.instagram.com/kad_kreamery",
    line: "#",
    deliver: "#",
    grabfood: "#",
    lineman: "#",
    robinhood: "#",
    gallery: [
      { src: "/assets/shop-gallery/Kad Kreamery/kadkreamery_1.webp" },
      { src: "/assets/shop-gallery/Kad Kreamery/kadkreamery_2.webp" },
      { src: "/assets/shop-gallery/Kad Kreamery/kadkreamery_3.webp" },
      { src: "/assets/shop-gallery/Kad Kreamery/kadkreamery_4.webp" },
  ...
  },
  {
    ...
    shopImg: "/assets/shop-gallery/Get Some Coffee/Logo B1_20250502-11.webp",
    keyword: "Get Some Coffee",
    about:
      "A specialty South Korean coffee house located in Seoul and Busan, known for quality coffee, handcrafted desserts and a variety of signature menus.",
    aboutTH:
      "ร้าน Specialty Coffee จากเกาหลี แบรนด์ดังจากโซลและปูซาน ขึ้นชื่อในเรื่องกาแฟที่มีรสชาติเป็นเอกลักษณ์ เมนูซิกเนเจอร์ และขนมหวานโฮมเมด",
    datetime: "09:00 AM - 9:00 PM",
    datetime2: "",
    tel: "081-664-9626",
    facebook: "#",
    ig: "https://www.instagram.com/get.some.coffee/?hl=en",
    line: "#",
    deliver: "#",
    grabfood: "#",
    lineman: "#",
    robinhood: "#",
    gallery: [
      { src: "/assets/shop-gallery/Get Some Coffee/getsomecoffee_1.webp" },
      { src: "/assets/shop-gallery/Get Some Coffee/getsomecoffee_2.webp" },
      { src: "/assets/shop-gallery/Get Some Coffee/getsomecoffee_3.webp" },
      { src: "/assets/shop-gallery/Get Some Coffee/getsomecoffee_4.webp" },
      { src: "/assets/shop-gallery/Get Some Coffee/getsomecoffee_5.webp" },
      { src: "/assets/shop-gallery/Get Some Coffee/getsomecoffee_6.webp" },
  ...
  },
  {
    id: 57,
    name: "Kingsman",
    shopImg: "/assets/shop-gallery/Kingsman/Logo B1_20250502-12.webp",
    keyword: "KingsmanBarbershop",
    about:
  ...
  },
  {
    id: 56,
    name: "Tonkatsu Aoki",
    shopImg: "/assets/shop-gallery/Tonkatsu Aoki/Logo B1_20250502-10.webp",
    keyword: "Tonkatsu Aoki",
    about:
      "A Japanese eatery specializing in tonkatsu, perfected through the Senmonten philosophy — mastering one dish with unwavering dedication. Enjoy golden, crispy pork cutlets that are tender, juicy, and crafted with pride.",
    aboutTH:
      "ร้านทงคัตสึญี่ปุ่นผู้เชี่ยวชาญด้าน เซ็นมงเต็น — ศาสตร์แห่งการทุ่มเทเพื่อทำเดียวให้สมบูรณ์แบบ ทุกจานพิถีพิถันตั้งแต่วัตถุดิบจนถึงเทคนิคเฉพาะ เพื่อรสชาติที่กรอบนอก นุ่มใน และเปี่ยมไปด้วยความตั้งใจ",
    datetime: "10:00 AM - 10:00 PM",
    datetime2: "",
    tel: "097-479-6425",
    facebook: "https://www.facebook.com/TonkatsuAokiThailand",
    ig: "https://www.instagram.com/tonkatsuaoki.thailand/?hl=en",
    line: "https://page.line.me/241kbyri?oat_content=url&openQrModal=true",
    deliver: "#",
    grabfood: "#",
    lineman: "#",
    robinhood: "#",
    gallery: [
      { src: "/assets/shop-gallery/Tonkatsu Aoki/tonkatsu_1.webp" },
      { src: "/assets/shop-gallery/Tonkatsu Aoki/tonkatsu_2.webp" },
      { src: "/assets/shop-gallery/Tonkatsu Aoki/tonkatsu_3.webp" },
      { src: "/assets/shop-gallery/Tonkatsu Aoki/tonkatsu_4.webp" },
      { src: "/assets/shop-gallery/Tonkatsu Aoki/tonkatsu_5.webp" },
      { src: "/assets/shop-gallery/Tonkatsu Aoki/tonkatsu_6.webp" },
  ...
  },
  {
    id: 55,
    name: "LAWOI' (ละโวยจ)",
    shopImg: "/assets/shop-gallery/LAWOI/LAWOI.webp",
    keyword: "LAWOIละโวยจ",
    about:
      "A seafood-forward concept from Chef Ton and Khun May, spotlighting premium ingredients and sake pairings. The cuisine balances clean techniques with personal storytelling.",
    aboutTH:
      "ร้านอาหารซีฟู๊ดแพร์ริ่งโดยเชฟต้นและคุณเมย์ ที่คัดสรรวัตถุดิบส่งตรงจากชาวประมงท้องถิ่นมาจับคู่กับสาเก ในบรรยากาศถ้ำชาวประมงที่อบอุ่นและสนุกสนาน",
    datetime: "17:00 PM - 23:00 PM",
    datetime2: "",
    tel: "082-052-1688",
    facebook: "https://www.facebook.com/profile.php?id=61568762188083",
    ig: "https://www.instagram.com/LAWOIBKK",
    line: "https://line.me/R/ti/p/@lawoibkk",
    deliver: "#",
    grabfood: "#",
    lineman: "#",
    robinhood: "#",
    gallery: [
      { src: "/assets/shop-gallery/LAWOI/LAWOI (1).webp" },
      { src: "/assets/shop-gallery/LAWOI/LAWOI (2).webp" },
      { src: "/assets/shop-gallery/LAWOI/LAWOI (3).webp" },
  ...
  },
  {
    id: 54,
    name: "JTAP (เจ๊แท๊ป)",
    shopImg: "/assets/shop-gallery/JTAP/JTAP.webp",
    keyword: "jtap",
    about:
      "A relaxed yet refined spot where simple cooking takes center stage. Centered on the five fundamentals—boil, steam, grill, fry, and stir-fry—every dish is crafted with care, skill, and bold, satisfying flavor.",
    aboutTH:
      "ร้านอาหารสไตล์สบายๆ ที่เน้นใช้วิธีทำอาหารแบบเรียบง่าย — ต้ม นึ่ง ย่าง ทอด ผัด — ใส่ใจในทุกรายละเอียด เติมความประณีต และรสจัดจ้านให้กับทุกจานที่คุ้นเคย",
    datetime: "Wednesday - Monday \n 18:00-23:00 PM",
    datetime2: "",
    tel: "083-995-1666",
    facebook: "#",
    ig: "https://www.instagram.com/jtap_langsuan",
    line: "#",
    deliver: "#",
    grabfood: "#",
    lineman: "#",
    robinhood: "#",
    gallery: [
      { src: "/assets/shop-gallery/JTAP/JTAP (1).webp" },
      { src: "/assets/shop-gallery/JTAP/JTAP (2).webp" },
      { src: "/assets/shop-gallery/JTAP/JTAP (3).webp" },
  ...
  },
  {
    id: 53,
    name: "Maison Roru",
    shopImg: "/assets/shop-gallery/Maison Roru/Maison roru.webp",
    keyword: "maisonmaru",
    about:
      "A culinary collaboration between Chef Masato and Pla iberry, known for combining Japanese finesse with Thai-inspired creativity in visually striking and refined dishes.",
    aboutTH:
      "ร้าน Handroll & Sake Bar ที่เกิดจากความร่วมมือระหว่างคุณปลา iberry และเชฟมาซาโตะ ชิมิสุ นำเสนอแฮนด์โรลวัตถุดิบชั้นเยี่ยมและเสิร์ฟด้วยความพิถีพิถันแบบญี่ปุ่นแท้ๆในทุกจาน",
    datetime: "10:00 AM - 22:00 PM",
    datetime2: "",
    tel: "061-888-2130",
    facebook: "https://www.facebook.com/maisonroru",
    ig: "https://www.instagram.com/maisonroru",
    line: "https://line.me/R/ti/p/@903zmumd?oat_content=url&ts=04241609",
    deliver:
      "https://www.erestaurants.co/modules/booking/book_form_section.php?redirect=1&data=&bkrestaurant=TH_BK_R_PlaMaisonRoru&bktitle=&city=&country=&bkextra=&bktracking=Instagram&hideimage=&bkdate=&restaurantselected=&bkpromo=&type=&notestext=&clientid=&language=",
    grabfood: "#",
    lineman: "#",
    robinhood: "#",
    gallery: [
      { src: "/assets/shop-gallery/Maison Roru/maison_1.webp" },
      { src: "/assets/shop-gallery/Maison Roru/maison_2.webp" },
      { src: "/assets/shop-gallery/Maison Roru/maison_3.webp" },
      { src: "/assets/shop-gallery/Maison Roru/maison_4.webp" },
      { src: "/assets/shop-gallery/Maison Roru/maison_5.webp" },
      { src: "/assets/shop-gallery/Maison Roru/maison_6.webp" },
  ...
  },
  {
    id: 52,
    name: "Heap Bar",
    shopImg: "/assets/shop-gallery/Heap/Heap Bar.webp",
    keyword: "heapbar",
    about:
      "A laid-back dining destination that places emphasis on quality cuisine. The menu showcases vibrant Thai flavors alongside inventive Western fusion dishes, complemented by an extensive drink selection. Guests can unwind in a spirited atmosphere enhanced by live music performances each evening.",
    aboutTH:
      "มากกว่ามื้ออาหารรสเด็ด คือประสบการณ์แห่งความสนุก! ร้านอาหารสไตล์นั่งชิล คัดสรรเมนูทั้งอาหารไทยที่รสชาติ จัดจ้าน ครบรส และเมนูอาหารฝรั่งแนวฟิวชั่น เสิร์ฟพร้อมเครื่องดื่มหลากหลาย ในบรรยากาศสนุนสนาน ด้วยวงดนตรีเล่นสดทุกคืน",
    datetime: "12:00 PM - 12:00 AM",
    datetime2: "",
    tel: "081-148-5171",
    facebook: "https://www.facebook.com/profile.php?id=61573878993893",
    ig: "https://www.instagram.com/heapvelaa",
    line: "#",
    deliver: "#",
    grabfood: "#",
    lineman: "#",
  ...
  },
  {
    id: 51,
    name: "Vilas วิลาศ",
    shopImg: "/assets/shop-gallery/vilas/vilas.webp",
    keyword: "Vilas",
    about:
      "VILAS, a Michelin-selected restaurant, offers neo-classic modern Thai cuisine — a reinterpretation of traditional Thai dishes infused with contemporary techniques and international influences, while preserving the bold, vibrant flavors of authentic Thai taste.",
    aboutTH:
      "ร้านอาหาร Michelin Selected นำเสนออาหารไทยสมัยใหม่แบบนีโอคลาสสิค โดยตีความอาหารไทยแบบดั้งเดิมผสมผสานเทคนิคการปรุงอาหารร่วมสมัย อิทธิพลจากนานาชาติ ในรสชาติแบบไทยที่จัดจ้าน",
    datetime: "17:30 AM - 23:00 PM",
    datetime2: "(Kitchen Closed at 10:00 PM)",
    tel: "094-997-8631",
